@if($seo)
    <meta name="title" Content="{{ $general->sitename(__(@$page_title??$pageTitle)) }}">
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $general->sitename(@$page_title??$pageTitle) }}">
    {{--<!-- Google / Search Engine Tags -->--}}
    <meta itemprop="name" content="{{ $general->sitename(@$page_title??$pageTitle) }}">
